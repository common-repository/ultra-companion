                ...
                <div class="meta-options">
                    <div class="format-type-field" id="format-gallery">
                        ...
                        <div class="format-input">
                            ...
                            <span class="add-img-btn" id="post_gallery_upload_button" title="<?php esc_attr_e( 'Add Images', 'ultra-companion' ); ?>"></span>
                        </div><!-- .format-input -->
                    </div><!-- #format-gallery -->
                </div>
            </div>
                ...
                <div class="meta-options">
                    <div class="format-type-field" id="format-video">
                        ...
                        <div class="format-input">
                            ...
                            <input class="button" type="button" id="reset-video-embed" value="<?php esc_attr_e( 'Reset url', 'ultra-companion' ); ?>" />
                        </div><!-- .format-input -->
                ...
                <div class="meta-options">
                    <div class="format-type-field" id="format-audio">
                        ...
                        <div class="format-input">
                            ...
                            <input class="button" name="media_upload_button" id="post_audio_upload_button" value="<?php esc_attr_e( 'Embed audio', 'ultra-companion' ); ?>" type="button" />
                            <input class="button" type="button" id="reset-audio-embed" value="<?php esc_attr_e( 'Reset url', 'ultra-companion' ); ?>" />
                        </div><!-- .format-input -->
                    </div><!-- #format-audio -->
                </div><!-- .meta-options -->
            </div><!-- .meta-row -->
